"""
cloud_day_trade_engine.py
เหมือน day_trade_engine.py เดิม แต่ import จาก cloud_database (คนละไฟล์ฐานข้อมูลกับพีซี)
"""
...
from cloud_database import open_paper_trade, close_paper_trade, get_open_trades
...
def get_day_trade_signal(ticker):
    try:
        ...
        return {
            ...
            "score": round(vol_ratio * 2 + (current_price - r1) / r1 * 100, 2),
        }
